    ...
    return (
        <div className="filter__box">
            ...
            <ul className={`filter__box__list ${droppedDown ? 'active' : ''}`}>
                ...
                <li className="filter__box__list__item" data-region="Africa">Africa</li>
                <li className="filter__box__list__item" data-region="Americas">Americas</li>
                <li className="filter__box__list__item" data-region="Asia">Asia</li>
                <li className="filter__box__list__item" data-region="Europe">Europe</li>
                <li className="filter__box__list__item" data-region="Oceania">Oceania</li>
                <li className="filter__box__list__item" data-region="Polar">Polar</li>
            </ul>
        </div>
    )
}
